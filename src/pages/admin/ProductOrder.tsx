          ...
          <tbody>
            {orders.map((order, idx) => (
              <tr key={order.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-2 border-b">{order.variation || "No variation"}</td>
                <td className="px-6 py-2 border-b">{order.departure.split('T')[0]}</td>
                <td className="px-6 py-2 border-b">{order.number_of_pax}</td>
                <td className="px-6 py-2 border-b">{order.per_pax_price.toLocaleString()}</td>
                <td className="px-6 py-2 border-b">{order.total_price.toLocaleString()}</td>
