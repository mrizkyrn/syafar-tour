...
const FaqSection: React.FC = () => {
  return (
    <section className="py-12 lg:py-16">
      <Container>
        <div className="flex flex-col items-center justify-center gap-5 mb-10 lg:mb-16 lg:px-24">
          <h1 className="text-4xl lg:text-5xl font-bold text-dark leading-tight lg:leading-snug text-center">Pertanyaan yang Sering Diajukan</h1>
          <p className="text-center text-sm lg:text-2xl leading-relaxed text-slate-500">
